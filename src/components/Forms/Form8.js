...
const [nav , setNav]=useState('Shree Gajanan Motor Driving School');
...
const handleSubmit=(e)=>{
    ...
    axios.post('https://sheet.best/api/sheets/1e02ecc8-a0b7-401b-8d87-29b198cf808b', data).then((response)=>{
      ...
      setEmail('');
      setDuration('');
      setNav('Shree Gajanan Motor Driving School');
    })
}
    ...
    return (
        ...
        <div className="maincontainer">
            ...
            <form onSubmit={handleSubmit}>
                    ...
                    <p>SHREE GAJANAN MOTOR DRIVING SCHOOL</p>
                    <p>ADDRESS : Survey No 73, Handewadi Road, Hadapsar, Shriram Chowk Opposite Runwal Seagull Near Ganga Village, Pune  </p>
                    <p>CONTACT NUMBER : (91)-20-39619622</p>
           ...
           id="gmap_canvas" src="https://maps.google.com/maps?q=SHREE%20GAJANAN%20MOTOR%20DRIVING%20SCHOOL,%20Hadapsar,%20Shriram%20Chowk%20Opposite%20Near%20Ganga%20Village,%20Pune%20&t=&z=13&ie=UTF8&iwloc=&output=embed" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" ></iframe>
